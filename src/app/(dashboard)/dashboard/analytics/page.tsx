...
import { ChevronDown, Calendar, TrendingUp, MessageSquare, Clock, BarChart3, Globe, Plus, Minus, MapPin } from "lucide-react";
    ...
    return (
        <div className="px-8 ">
            <div className="">
                ...
                {/* Data Table Section */}
                <div className="bg-white rounded-xl border border-gray-200 p-6 mb-8">
                    <h2 className="text-lg font-semibold text-[#1d1d1f] mb-4">Chat History</h2>
                    
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-200">
                                    <th className="text-left py-3 px-4 text-sm font-medium text-[#666666]">Date</th>
                                    <th className="text-left py-3 px-4 text-sm font-medium text-[#666666]">Number of Chats</th>
                                    <th className="text-left py-3 px-4 text-sm font-medium text-[#666666]">Number of Messages</th>
                                </tr>
                            </thead>
                            <tbody>
                                {chatData.map((row, index) => (
                                    <tr key={index} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                                        <td className="py-3 px-4 text-sm text-[#1d1d1f]">{row.date}</td>
                                        <td className="py-3 px-4 text-sm text-[#1d1d1f]">{row.chats}</td>
                                        <td className="py-3 px-4 text-sm text-[#1d1d1f]">{row.messages}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
